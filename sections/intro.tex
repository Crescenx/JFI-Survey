...
mixed strategies~\cite{Neumann1928}, and von Neumann and Morgenstern incorporated
this result into a general theory of economic behavior~\cite{vNM1944}. Nash
...
inference~\cite{Amos2022Amortized,KingmaWelling2014}, and it has also been used
...
play~\cite{Moravcik2017,BrownSandholm2018,BrownReBeL2020}. Self-play with
...
markets~\cite{Calvano2020,Assad2024}. Language models negotiate and
coordinate~\cite{Bianchi2024NegotiationArena,Akata2025}, while preference-based
training procedures use human feedback on model outputs to train policies,
often via learned reward models~\cite{Christiano2017,Ouyang2022}.
...
gradient search over sampled valuation profiles~\cite{Duetting2019}. Poker
systems report performance against a test population
~\cite{Moravcik2017,BrownSandholm2018,BrownReBeL2020}, while pricing audits
estimate regret against alternatives recoverable from deployment logs. Each
result provides evidence for sampled cases and accessible alternatives. Some
target properties are defined over a larger deviation class than the evaluation
examines. For example, they require that no deviation in the specified class be
...
learning fall outside our selected domains. Wellman et al.\ and Curry et al.\
provide focused reviews of empirical game-theoretic analysis and automated
mechanism design, respectively
~\cite{WellmanTuylsGreenwald2025,CurryAMDSurvey2025}. Sun et
...
provides one formalization of such feedback~\cite{Perdomo2020Performative}. The
relevant response process and case domain must therefore be specified as part
of the claim.
