...
Both output and system validity are needed to connect a learned output to a
system-level claim. This section derives the combined condition, compares the
evidentiary demands across the six domains, and identifies research priorities.
